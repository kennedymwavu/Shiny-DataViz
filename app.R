        ...
        mainPanel(
            ...
            fluidRow(
                column(
                    ...
                    downloadButton(outputId = "sample_ds", label = "Download Sample Dataset .csv"), 
            ...
            mainPanel(
                ...
                fluidRow(
                    column(
                        ...
                        downloadButton(outputId = "downloadData", label = "Summary Table .csv")
                    ), 
                    ...
                    column(
                        ...
                        downloadButton(outputId = "downloadImage", "Summary Plot .png")
                    )
                ), 
    ...
    tidy_d <- reactive({
        tr <- function(whole_d) {
            ...
            whole_d %<>% sapply(., as.numeric) %>% as_tibble() %>% 
                ...
                # Change column names:
                rename_with(function(x) colnames(df_f))
